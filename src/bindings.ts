...
export type SageAppCommonView = { identity: SageAppIdentityView; grantedPermissions: SageGrantedPermissionsView; activeSnapshot: SageAppSnapshotView; icon: SageAppIconView | null }
...
export type SageAppUrlPreview = { appUrl: SageAppUrl; manifestHash: string; manifest: SageAppPackageManifestPreview }
...
export type SageGrantedNetworkPermissionsInput = { whitelist: SageNetworkWhitelistEntry[] }
