...
export type GetCatCoins = { asset_id: string; offset: number; limit: number; sort_mode?: CoinSortMode }
...
export type GetXchCoins = { offset: number; limit: number; sort_mode?: CoinSortMode }
