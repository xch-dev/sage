...
export type TransactionInput = ({ type: "unknown" } | { type: "launcher" } | { type: "token"; asset_id: string; name: string | null; icon_url: string | null; ticker: string | null; precision: number; is_xch: boolean } | { type: "did"; asset_id: string; name: string | null; icon_url: string | null } | { type: "nft"; asset_id: string; name: string | null; icon_url: string | null } | { type: "option" }) & { coin_id: string; amount: Amount; address: string; outputs: TransactionOutput[] }
...
export type TransactionRecordCoin = ({ type: "unknown" } | { type: "launcher" } | { type: "token"; asset_id: string; name: string | null; icon_url: string | null; ticker: string | null; precision: number; is_xch: boolean } | { type: "did"; asset_id: string; name: string | null; icon_url: string | null } | { type: "nft"; asset_id: string; name: string | null; icon_url: string | null } | { type: "option" }) & { coin_id: string; amount: Amount; address: string | null; address_kind: AddressKind; precision: number }
