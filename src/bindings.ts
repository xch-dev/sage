...
export type SignMessageByAddress = { message: string; address: string; hex?: boolean }
export type SignMessageByAddressResponse = { publicKey: string; signature: string }
export type SignMessageWithPublicKey = { message: string; publicKey: string; hex?: boolean }
