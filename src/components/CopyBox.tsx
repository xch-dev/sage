  ...
  return (
    <div className={`flex rounded-md shadow-sm max-w-lg ${props.className}`}>
      <input
        ...
        value={props.content}
        readOnly
        className='block w-full text-sm rounded-none rounded-l-md border-0 py-1.5 px-2 truncate text-muted-foreground bg-white text-neutral-950 dark:bg-neutral-900 dark:text-neutral-50 font-mono tracking-tight ring-1 ring-inset ring-neutral-200 dark:ring-neutral-800 sm:leading-6'
      />
      <CopyButton
        value={props.content}
